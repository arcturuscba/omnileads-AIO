...
function draw(plot, neighbor) {
    ...
    function showTooltip(plot, series, neighbor) {
        ...
        if (opts.useAxesFormatters) {
            ...
            var index = ((neighbor.data[0]-1)*2)+1;
            if(hl.useXTickMarks && series._xaxis._ticks[index]) {
                xstr = xf(xfstr, series._xaxis._ticks[index].label); 
            }
        ...
        switch (loc[locationIndicies[opts.tooltipLocation]]) {
            case 'nw':
                var cantidadSeries = series._plotSeriesInfo[1];
