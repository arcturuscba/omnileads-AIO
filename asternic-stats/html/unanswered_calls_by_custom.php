<?php
// Unanswered calls by custom field
...
//
// With that in place, you can have that column in detailed unanswered reports. 
...
// unanswered_reports in the Designer

$resource = basename(__FILE__);
if( check_acl($resource)) {
    unanswered_calls($resuna,'HTML','MyField');
}
